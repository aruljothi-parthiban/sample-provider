...
[![Can I deploy Status](https://testdemo.pactflow.io/pacticipants/sample-provider/branches/master/latest-version/can-i-deploy/to-environment/production/badge)](https://testdemo.pactflow.io/pacticipants/sample-provider/branches/master/latest-version/can-i-deploy/to-environment/production/badge)
...
- [sample-consume](https://github.com/pactflow/example-bi-directional-consumer-mountebank)
...
- `PACT_PROVIDER=sample-provider`: Dredd - (https://github.com/pactflow/example-bi-directional-provider-dredd)
